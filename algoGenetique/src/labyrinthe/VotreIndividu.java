...
public class VotreIndividu implements Individu{
    ...
    public VotreIndividu(VotreLabyrinthe lab){
     ...
     //RETOURNE LA DISTANCE À LA CELLULE DE SORTIE DE LA DERNIERE CELLULE DE CHEMIN VALIDE
    ...
    public int[] InfoGenome(){
        ...
        /*On prend le genome et on regarde  :
           - quels sont les endroits où il n'y a pas de mur
           - si la direction prise par le génome est bonne
           - si oui : on passe à la case suivante et on réitère le procéssus
           - si non : on calcul le score du génome
        */ 
        ...
        while(i<nbl*nbc){
            ...
            /*Après avoir regarder tous les murs disponible on test si le genome ne saute pas un mur :
            si non, on passe aux coordonnées suivantes*/
        ...
        this.il=il;
        this.ic=ic;
        //System.out.print("Les coordonnées de la case limite sont : "+ il+", "+ic+"\nLa longueur est : "+lim+"\n");
