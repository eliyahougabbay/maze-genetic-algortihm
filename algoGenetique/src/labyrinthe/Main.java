...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        /*
         * TEST VotrePopulation int nl=5,nc=5; VotreLabyrinthe lab= new
         * VotreLabyrinthe(nl,nc); lab.CreerLabyrinte(); VotreIndividu ind = new
         * VotreIndividu(lab); ind.afficher(); int[] liste = ind.InfoGenome();
         * System.out.println("Score : "+ind.getScore(liste[0], liste[1]));
         * /*VotrePopulation pop=new VotrePopulation(1,nl,nc,lab); pop.Afficher();
         * System.out.print("\nAprès selection :"); pop.Selection(); pop.Afficher();
         * System.out.print("\n");
         */
